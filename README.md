...
* Adapte la ruta en la línea `49` para que coincida con la carpeta principal de $\textsc{SPheno}$ en su dispositivo.
...
Para $\sim 300$ puntos de referencia el procesamiento tarda al rededor de $15$ minutos.
